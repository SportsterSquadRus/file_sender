...
- Находячсь в в папке сервера запустите его командой sudo docker-compose up;
- Находясь в папке агента запустите его командой python3 client.py (предупреждение, агент уже содержит тестовый файл ждя отправки на сервер. Удалите его в случае необходимости.).
